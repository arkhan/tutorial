...
# import odoo
# import werkzeug
# from odoo.http import (HttpRequest, JsonRequest, Root, SessionExpiredException,
#                        WebRequest, request)
...
# _handle_exception = (
#     JsonRequest._handle_exception
# )  # original json _handle_exception method
...
#             self.httprequest,
#             **json.loads(self.httprequest.get_data().decode(self.httprequest.charset))
#         )
#     try:
